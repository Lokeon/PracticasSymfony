...
class ArticuloController extends AbstractController
{
    ...
    {
        return $this->render('articulo/index.html.twig', ['articulos' => $articuloRepository->findAll()]);
    }
    ...
    {
        return $this->render('articulo/show.html.twig', ['articulo' => $articulo]);
    }
    ...
    public function edit(Request $request, Articulo $articulo): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('articulo_index', ['id' => $articulo->getId()]);
        }
